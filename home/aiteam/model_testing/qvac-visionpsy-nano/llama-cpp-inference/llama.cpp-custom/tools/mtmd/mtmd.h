...
// iteration over chunks held by an mtmd_batch (read-only, non-owning).
MTMD_API size_t                    mtmd_batch_n_chunks (const mtmd_batch * batch);
MTMD_API const mtmd_input_chunk *  mtmd_batch_get_chunk(const mtmd_batch * batch, size_t idx);
